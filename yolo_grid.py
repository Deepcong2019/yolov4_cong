...
class YOLO(object):
    ...
    def detect_image(self, image ):
        ...
        #   将图像输入网络当中进行预测！
        #---------------------------------------------------------#
        npz_data = np.load('./model_data/grid_date_dzb.npz', allow_pickle=True)
        id =npz_data['id']
        ...
        for i, c in list(enumerate(out_classes)):
            ...
            draw.text([0, (i+1)*40], "class=%s id=%s "%(predicted_class,(index-1)), fill='red', font=font)
